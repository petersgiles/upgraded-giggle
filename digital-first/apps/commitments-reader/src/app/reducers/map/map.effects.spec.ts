...
import { GetMapPointsFailure, GetRefinedMapPoints } from './map.actions'
...
describe('MapEffects', () => {
  ...
  it('should Load Map Points', inject(
    [MapPointsSearchGQL],
    (getMapPointsGQL: MapPointsSearchGQL) => {
  ...
  it('should show error on error', inject(
    [MapPointsSearchGQL],
    (getMapPointsGQL: MapPointsSearchGQL) => {
