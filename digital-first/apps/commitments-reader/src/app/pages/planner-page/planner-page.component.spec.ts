  ...
  beforeEach(async(() => {
        ...
        providers: [
          ...
          provideMockStore({
            ...
            selectors: [
              ...
              {
                selector: selectExternalEventTypesState,
                value: initialState.externalEventTypes
              },
              { selector: getUserCurrentUser, value: userState.user },
              {
                selector: getUserCurrentUserPermissions,
                value: userState.operations
              },
              {
                selector: selectSelectedExternalEventTypesState,
                value: initialState.selectedExternalEventTypes
              },
              {
                selector: selectPlannerPermissionState,
                value: initialState.readonly
              },
              {
                selector: selectExternalEventsState,
                value: initialState.externalEvents
              },
              {
                selector: selectSchedulerCenterDateState,
                value: initialState.schedulerCenterDate
              },
              {
                selector: selectSchedulerPageIndexState,
                value: initialState.schedulerPageIndex
              }
            ]
          })
        ]
    ...
    configureTests(configure).then(testBed => {
      ...
      mockStore.overrideSelector(
        ...
        initialState.externalEventTypes
      )
      mockStore.overrideSelector(
      ...
      mockStore.overrideSelector(
        getUserCurrentUserPlannerPermission,
        userState.user
      )
