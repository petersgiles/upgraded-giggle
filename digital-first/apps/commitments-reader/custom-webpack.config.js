  ...
  plugins: [
    new HtmlWebpackPlugin({
      ...
      sp: {
        ...
        basePath: `<base runat="server" href="<% $SPUrl:~site/SitePages/commitments-reader.aspx/ %>" />`,
        favIcon: `<link rel="icon" type="image/png" sizes="32x32" href="<% $SPUrl:~site/SiteAssets/apps/commitments-reader/favicon.ico %>">`
      },
      chunks: ['runtime', 'vendor', 'polyfills-es5', 'polyfills', 'main', 'styles'],
      chunksSortMode: 'manual',
      template: './sharepoint.template.html',
      filename: '../../../SitePages/commitments-reader.aspx' //relative to root of the application
    })
  ]
}
