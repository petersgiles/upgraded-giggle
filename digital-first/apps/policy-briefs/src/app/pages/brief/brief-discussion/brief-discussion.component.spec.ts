...
describe('BriefDiscussionComponent', () => {
  ...
  beforeEach(async(() => {
    ...
    configureTests(configure).then(testBed => {
      ...
      mockStore.overrideSelector(
        fromDiscussion.selectDiscussionState,
        initialState.discussion
      )
      mockStore.overrideSelector(
        fromDiscussion.selectActiveCommentState,
  ...
  it('should return two discussions', () => {
    mockStore.select(fromDiscussion.selectDiscussionState).subscribe(result => {
