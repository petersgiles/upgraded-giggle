...
export type MutationCreateStatisticElectorateTableReportArgs = {
  messageId: Scalars['Guid'],
  conversationId?: Maybe<Scalars['Guid']>,
  statisticElectorateTableReport?: Maybe<CreateStatisticElectorateTableReportGraph>
};
...
export type MutationUpdatePmcHandlingAdviceCommitmentArgs = {
  messageId: Scalars['Guid'],
  conversationId?: Maybe<Scalars['Guid']>,
  updatePmcHandlingAdviceCommitment?: Maybe<UpdatePmcHandlingAdviceCommitmentGraph>
};
...
export type MutationUpdatePmoHandlingAdviceCommitmentArgs = {
  messageId: Scalars['Guid'],
  conversationId?: Maybe<Scalars['Guid']>,
  updatePmoHandlingAdviceCommitment?: Maybe<UpdatePmoHandlingAdviceCommitmentGraph>
};
...
export type Query = {
  ...
  projects?: Maybe<Array<Maybe<ProjectGraph>>>,
  deckItemBriefSummaryContent?: Maybe<Array<Maybe<DeckItemBriefSummaryContentGraph>>>,
  report: ReportGraph,
  reports?: Maybe<Array<Maybe<ReportGraph>>>,
  ...
  pmoHandlingAdviceCommitments?: Maybe<Array<Maybe<PmoHandlingAdviceCommitmentGraph>>>,
  relatedLinks?: Maybe<Array<Maybe<RelatedLinkGraph>>>,
  siteCommitmentDisplayOrders?: Maybe<Array<Maybe<SiteCommitmentDisplayOrderGraph>>>,
};
...
export type BriefsQueryVariables = {
  webId?: Maybe<Array<Maybe<Scalars['String']>>>,
  siteId?: Maybe<Array<Maybe<Scalars['String']>>>,
  listId?: Maybe<Array<Maybe<Scalars['String']>>>,
  briefId?: Maybe<Array<Maybe<Scalars['String']>>>
};
...
export const BriefsDocument = gql`
  ...
  briefs(where: [{path: "webId", comparison: equal, value: $webId}, {path: "siteId", comparison: equal, value: $siteId}, {path: "listId", comparison: equal, value: $listId}, {path: "listItemId", comparison: equal, value: $briefId}]) {
    id
    text: title
    webId
    siteId
  ...
  export class BriefsGQL extends Apollo.Query<BriefsQuery, BriefsQueryVariables> {
    document = BriefsDocument;
    
  }
export const CommitmentsLbsDocument = gql`
    query CommitmentsLBS($refiner: CommitmentRefinerGraph!, $bookType: BookType!) {
  ...
  export class CommitmentsLbsGQL extends Apollo.Query<CommitmentsLbsQuery, CommitmentsLbsQueryVariables> {
    document = CommitmentsLbsDocument;
    
  }
export const DeleteBriefCommitmentDocument = gql`
    mutation DeleteBriefCommitment($messageId: Guid!, $deleteBriefCommitment: DeleteBriefCommitmentInputGraph) {
  deleteBriefCommitment(messageId: $messageId, deleteBriefCommitment: $deleteBriefCommitment) {
    id
  }
}
    `;
  ...
  export class DeleteBriefCommitmentGQL extends Apollo.Mutation<DeleteBriefCommitmentMutation, DeleteBriefCommitmentMutationVariables> {
    document = DeleteBriefCommitmentDocument;
    
  }
export const SaveBriefCommitmentDocument = gql`
    mutation SaveBriefCommitment($messageId: Guid!, $createBriefCommitment: CreateBriefCommitmentInputGraph) {
  createBriefCommitment(messageId: $messageId, createBriefCommitment: $createBriefCommitment) {
    id
  }
}
    `;
  ...
  export class SaveBriefCommitmentGQL extends Apollo.Mutation<SaveBriefCommitmentMutation, SaveBriefCommitmentMutationVariables> {
    document = SaveBriefCommitmentDocument;
