...
export class RelatedCommitmentDataSharePointService implements RelatedCommitmentDataService {
    ...
    removeItemFromCommitment(payload: any): Observable<any> {
      ...
      getItemsByCommitment(commitment: any): Observable<DataResult<RelatedCommitmentsResult>> {
